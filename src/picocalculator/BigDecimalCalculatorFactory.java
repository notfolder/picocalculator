...
public class BigDecimalCalculatorFactory extends AbstractCalculatorFactory<BigDecimal> {
    /** 整数値用Lexer生成ファクトリ */
    ...
    public AbstractParser<BigDecimal> createParser() {
        // 四則演算のみParser生成
        AbstractParserFactory<BigDecimal> factory = new SimpleParserFactory<BigDecimal>();
